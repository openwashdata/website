...
The development team is constantly working on organizing, cleaning, and releasing new datasets. The following sections introduce you two common ways to use openwashdata.

## 1.1 Let's do R, why not 🥳

If you have worked with [R programming](https://www.r-project.org)[^1], we are actively developing new R data packages. You could access the data by installing the package in R and start from there. For example, we have released the dataset `wasteskipsblantyre` that contains locations of the waste skips in Blantyre, Malawi from year 2021.
...
[^2]: The figure is a screenshot from `wasteskipsblantyre` [package website](https://openwashdata.github.io/wasteskipsblantyre/).

![](download-dataset.png){fig-alt="screenshot of downloading spreadsheet data"}
