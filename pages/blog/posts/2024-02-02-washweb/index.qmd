---
title: Strategic partnership with WASHWeb
subtitle: The WASHWeb & openwashdata partnership is a significant step forward
description: |
  A description could be place here.
categories:
  - partnership
  - open data
  - accountability
author:
  - name: Merel Laauwen
    url: https://www.linkedin.com/in/merel-laauwen/
    affiliation: Independent Consultant
    affiliation-url: https://lwn.earth/
date: "2024-02-06"
draft: false
image: "thumbnail.jpg"
...
-   Setting up a registry of who is doing what, when, and where in the WASH sector (4Ws) so that data can be better contextualized

## Moving towards open data and code

The majority of data and information in the water, sanitation, and hygiene (WASH) sector, such as reports, datasets, and analyses, remain largely in the hands of experts and is not widely shared. Even information that is available, is often in formats or platforms that are not (easily) reusable for further research. To target this need, WASHWeb and openwashdata have set these joint activities.
...
If you're curious to know more about the origin of WASHWeb, you can read more in [our introductory blogpost](https://washweb.org/posts/2023-09-26-intro/). Learn more about joining the WASHWeb community [on our website](https://washweb.org/join.html).
