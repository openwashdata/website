...
5.  Configure Git version control on your local computer, in console,
    run:
...
7.  Open **Terminal** (the tab next to Console), connect remote
    repository on GitHub with local repository. Run commands suggested
    in your assigned GitHub repository. The commands should look like
    the following where `URL` is replaced by your assigned repo url
