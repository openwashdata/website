...
This is a copy of the proposal as it was submitted to, and supported by the [Open Research Data Program of the ETH Board](https://ethrat.ch/en/eth-domain/open-research-data/). The original version is stored in [this GitHub repository](https://github.com/openwashdata/proposal-eth-ord-scheme).
...
readr::read_csv(here::here("pages/gallery/proposal/learner-personas.csv")) |> 
